  ...
  const handleShow = () => setShow(true);
   ...
   <div className="center">
          ...
          <div className="flip">
            <div className="front">
              ...
              <div className="card-number"> 
                <div className="section"><p>{info.cardNumber}</p></div>
              </div>
              <div className="end"><span className="end-text">exp. end:</span><span className="end-date">{info.cardMonth}/{info.cardYear}</span></div>
              <div className="end"><span className="end-text">Cvc:</span><span className="end-date">{info.cardCvc}</span></div>
              <div className="card-holder">{info.fullName}</div>
     ...
     <input
      ...
      maxLength={3}
       />
<Button className='check-btn'  onClick={handleShow}>
Confirm The Order
      </Button>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>Your order has been recorded,
                        Thank you for choosing us,success!</Modal.Body>
        <Modal.Footer>
          <Link to={'/'}style={{textDecoration:"none",color:"#ff0000"}} className="check-a" variant="primary" onClick={handleClose}>
            Continue Shopping!
          </Link>
        </Modal.Footer>
      </Modal>
